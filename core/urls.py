...
from .views import (
    inicio, registrarme, nosotros, productos, usuarios, bodega, ventas, boleta,
    ingresar, misdatos, miscompras, salir, carrito, ficha, cambiar_estado_boleta,
    poblar, obtener_productos, eliminar_producto_en_bodega, premio,
    eliminar_producto_en_carrito, agregar_producto_al_carrito, vaciar_carrito,
    mipassword, cambiar_password, comprar_ahora, administracion
)
