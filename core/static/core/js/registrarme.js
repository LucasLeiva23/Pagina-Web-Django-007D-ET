$(document).ready(function() {
  ...
  $('#id_username').attr('placeholder', 'Nombre ususario. EJ: tulio_trib');
  $('#id_first_name').attr('placeholder', 'Nombre EJ: Juan');
  $('#id_last_name').attr('placeholder', 'Apellido EJ: soto');
  $('#id_email').attr('placeholder', 'Correo   Ej:tulio.juan@pesc.com');
  $('#id_password1').attr('placeholder', 'contraseña 8 caracteres como mínimo');
  $('#id_password2').attr('placeholder', 'Repetir la contraseña escogida');
  $('#id_rut').attr('placeholder', 'Rut Ej:11111111-1(sin puntos y con guión)');
